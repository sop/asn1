 ...
 * @internal
 */
class GeneralizedTimeEncodeTest extends TestCase
{
    ...
    {
        $ts = strtotime('Mon Jan 2 15:04:05 MST 2006');
        $dt = \DateTimeImmutable::createFromFormat('U.u', "{$ts}.000000",
            new \DateTimeZone('UTC'));
        $el = new GeneralizedTime($dt);
        $this->assertEquals("\x18\x0f" . '20060102220405Z', $el->toDER());
    }
    ...
    {
        $ts = strtotime('Mon Jan 2 15:04:05 MST 2006');
        $dt = \DateTimeImmutable::createFromFormat('U.u', "{$ts}.100000",
            new \DateTimeZone('UTC'));
        $el = new GeneralizedTime($dt);
